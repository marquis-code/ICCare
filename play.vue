          ...
          <div class="mb-6">
            ...
            <div class="flex flex-wrap gap-3 mb-6">
              <button 
                ...
                class="bg-[#005B8F] text-white px-4 py-2.5 rounded-lg hover:bg-[#004a73] transition-colors flex items-center gap-2 shadow-sm"
              >
                <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_2108_3013)">
                    <path d="M3.01562 0C1.9125 0 1.01562 0.896875 1.01562 2V14C1.01562 15.1031 1.9125 16 3.01562 16H11.0156C12.1187 16 13.0156 15.1031 13.0156 14V11H15.4563L14.4875 11.9688C14.1938 12.2625 14.1938 12.7375 14.4875 13.0281C14.7812 13.3187 15.2563 13.3219 15.5469 13.0281L17.7969 10.7781C18.0906 10.4844 18.0906 10.0094 17.7969 9.71875L15.5469 7.46875C15.2531 7.175 14.7781 7.175 14.4875 7.46875C14.1969 7.7625 14.1938 8.2375 14.4875 8.52812L15.4563 9.49687H13.0156V5.325C13.0156 4.79375 12.8062 4.28438 12.4312 3.90937L9.1 0.584375C8.725 0.209375 8.21875 0 7.6875 0H3.01562ZM11.1875 5.5H8.26562C7.85 5.5 7.51562 5.16563 7.51562 4.75V1.82812L11.1875 5.5ZM7.01562 10.25C7.01562 9.83438 7.35 9.5 7.76562 9.5H11.0156V11H7.76562C7.35 11 7.01562 10.6656 7.01562 10.25Z" fill="white"/>
            ...
            <!-- Approval Table -->
            <div v-if="pendingApprovals.length > 0" class="bg-white rounded-lg shadow-sm max-w-lg overflow-hidden mb-6 border-[0.5px] border-gray-100">
              ...
              <div class="overflow-x-auto">
                <table class="w-full">
                  <thead class="bg-gray-25 border-b-[0.5px] border-gray-50">
                    <tr>
                      <th class="px-4 py-6 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">SN</th>
                      <th class="px-4 py-6 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Sample ID</th>
                      <th class="px-4 py-6 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Actions</th>
                    </tr>
                  </thead>
                ...
                <table class="w-full">
                  <thead class="bg-gray-25 border-b-[0.5px] border-gray-50">
                    <tr>
                      <th class="px-4 py-6 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">SN</th>
                      <th class="px-4 py-6 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Sample ID</th>
                      <th class="px-4 py-6 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Current Location</th>
                      <th class="px-4 py-6 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Previous Location</th>
                      <th class="px-4 py-6 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Move On</th>
                      <th class="px-4 py-6 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Collector Info</th>
                      <th class="px-4 py-6 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Description</th>
                      <th class="px-4 py-6 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Status</th>
                    </tr>
                  </thead>
                  <tbody class="divide-y-[0.5px] divide-gray-50 bg-white">
                    <tr 
                    ...
                    >
                      ...
                      <td class="px-4 py-6 text-sm text-gray-700">{{ formatDate(specimen.moveOn) }}</td>
