<template>
    <div class="min-h-screen">
        ...
        <Teleport to="body">
            <div v-if="showCreateModal" class="fixed bg-black/50 backdrop-blur-lg inset-0 z-[9999] overflow-y-auto" aria-labelledby="modal-title"
        ...
        <Teleport to="body">
            <div v-if="showDetailsModal" class="fixed bg-black/50 backdrop-blur-lg z-[9999] inset-0 overflow-y-auto"
