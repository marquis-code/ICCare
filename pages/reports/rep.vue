          ...
          <section class="bg-white rounded-xl p-6 space-y-4 shadow-sm border border-gray-100">
            ...
            <div class="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-200">
              <button 
                ...
                class="flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
              ...
              <button 
                ...
                class="flex items-center justify-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors disabled:opacity-50">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="sm:flex sm:items-start">
                  ...
                  <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                    ...
                    <div class="mt-4">
                      ...
                      <select v-model="exportFormat" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                  ...
                  <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                    ...
                    <div class="mt-4 space-y-4">
                      ...
                      <div>
                        ...
                        <select v-model="scheduleForm.scheduled_period" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                      ...
                      <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Recipient Roles (comma-separated)</label>
                        <input 
                          v-model="scheduleForm.recipient_roles_text" 
                          type="text"
                          placeholder="admin, inventory_manager"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                        />
                      </div>
                    </div>
                    ...
                    <div class="mt-4 space-y-4">
                      <div>
                        ...
                        <input 
                          ...
                          type="text"
                          placeholder="e.g., Reagent Buffer A"
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          type="text"
                          placeholder="e.g., liters, vials, boxes, celsius"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                        />
                      </div>
