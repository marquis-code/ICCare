...
<Teleport to="body">
  <Transition name="modal">
    ...
    >
      <div class="flex items-center justify-center h-[500px] px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <!-- Background overlay -->
          ...
          <div class="px-6 py-6 space-y-6">
            ...
            <div>
              ...
              <div class="relative" ref="permissionDropdownRef">
                ...
                <!-- Dropdown with full height -->
                <Transition name="dropdown">
                  <div
                    v-if="showPermissionDropdown"
                    class="absolute z-10 w-full mt-1 bg-white border-[0.5px] border-gray-100 rounded-md shadow-lg h-96 overflow-auto"
                  >
                    <div class="py-2">
                      <label
