...
<!--        &lt;!&ndash; Create Modal (Teleport) &ndash;&gt;-->
<!--        <Teleport to="body">-->
...
<!--                                        </div>-->
<!--                                        <div>-->
<!--                                            &lt;!&ndash; <label class="block text-sm font-medium text-gray-700">Description *</label> &ndash;&gt;-->
...
<!--                                            <UiSelectInput v-model="rackForm.site_id" :options="siteOptions" label="Site"-->
<!--                                                @update:modelValue="loadFreezersForRack" />-->
...
<!--                                                &lt;!&ndash; Custom option rendering in dropdown &ndash;&gt;-->
<!--                                                <template #default="{ option }">-->
<!--                                                    {{ option.template_name }} ({{ option.rows }}x{{ option.columns }})-->
<!--                                                </template>-->

<!--                                                &lt;!&ndash; Custom selected value display &ndash;&gt;-->
...
<!--                                        </div>-->
<!--                                        <div>-->
<!--                                            &lt;!&ndash; <label class="block text-sm font-medium text-gray-700">Total-->
<!--                                                Positions</label> &ndash;&gt;-->
...
<!--        &lt;!&ndash; Details Modal (Teleport) &ndash;&gt;-->
<!--        <Teleport to="body">-->
